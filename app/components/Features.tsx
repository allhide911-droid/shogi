...
const targetCards = [
  {
    image: "/images/教室風景.png",
    tag: "こどもクラス / 小学生〜中学生",
    title: "将棋を始めたいお子さん・親御さんへ",
    body: "「集中力をつけさせたい」「論理的な思考を育てたい」。将棋は子どもの成長に絶大な効果があります。高橋講師による丁寧な指導で、楽しみながら力が伸びます。",
  },
  {
    image: "/images/夕方将棋風景.png",
    tag: "一般クラス / 高校生〜シニア",
    title: "趣味を持ちたい・仲間を作りたい大人の方へ",
    body: "仕事帰りの集中できる時間、週末の充実した趣味として。同じ将棋好きの仲間と過ごす時間は、生涯の財産になります。初心者も有段者も、夕暮れ時の教室で盤を囲みましょう。",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: "#555" }}
            >
              王手将棋教室が選ばれる理由。将棋を楽しみながら、確実に実力が伸びる環境をご用意しています。
            </p>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="font-mincho text-3xl sm:text-4xl font-bold mb-4 text-white">
              こんな方を、お待ちしています。
            </h2>
            <div className="kin-divider w-20 mx-auto mb-6" />
            <p
              ...
              >
                ...
                <div className="relative h-52 overflow-hidden">
                  <Image
                    ...
                    className="object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#111c35]/60 to-transparent" />
                </div>
                {/* Card content */}
                <div className="p-6 sm:p-8">
                  ...
                  <h3 className="font-mincho text-xl font-bold mb-3 text-white">
                    {card.title}
                  </h3>
                  <div className="kin-divider w-12 mb-4" />
                  <p
