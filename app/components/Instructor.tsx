...
const instructors = [
  {
    ...
    rank: "七段",
    rankEn: "7th Dan",
    bio: "日本将棋連盟所属。大阪府将棋選手権優勝（2008・2012年）、全国アマチュア選手権出場経験を持つ。将棋教育の普及に情熱を注ぎ、15年以上にわたり子どもから大人まで幅広い世代を指導。「将棋は人を育てる」を信条に、礼節と探究心を大切にした指導を行っている。",
    achievements: [
      "日本将棋連盟 公認指導員",
  ...
  },
  {
    ...
    rank: "五段",
    rankEn: "5th Dan",
    bio: "女性棋士として活躍後、指導者の道へ。特に子どものクラスを担当し、将棋を通じた論理的思考力・集中力の育成に力を入れる。「負けから学ぶ」指導スタイルで、生徒の自主的な成長を促す。保護者からの信頼も厚い。",
    achievements: [
      "日本将棋連盟 女流認定棋士",
      "近畿地区女流選手権 準優勝",
      "こども将棋指導員 資格保有",
